...
ALLOWED='^(DATABASE_URL|WORKER_INTERNAL_TOKEN|WORKER_CORS_ALLOWED_ORIGINS|INTERNAL_CALLBACK_SECRET|APP_URL|FEISHU_APP_ID|FEISHU_APP_SECRET|FEISHU_BITABLE_APP_TOKEN|FEISHU_CAMPAIGNS_TABLE_ID|FEISHU_CONTENT_QUEUE_TABLE_ID|FEISHU_PERFORMANCE_TABLE_ID|FEISHU_REVIEW_CHAT_ID|ANTHROPIC_API_KEY|ANTHROPIC_BASE_URL|MARKETING_COMPOSER_MODEL|MARKETING_FALLBACK_API_KEY|MARKETING_FALLBACK_BASE_URL|MARKETING_FALLBACK_MODEL|GROWTH_OS_PUBLIC_URL|FMP_API_KEY|SEC_USER_AGENT|DATAFORSEO_LOGIN|DATAFORSEO_PASSWORD|TAVILY_API_KEY|TELEGRAM_BOT_TOKEN|TELEGRAM_BOT_USERNAME|TELEGRAM_CHANNEL_HANDLE|TELEGRAM_GROUP_ID_VIP|WHOP_API_KEY|WHOP_APP_ID|WHOP_COMPANY_ID|WHOP_FORUM_EXPERIENCE_ID|WHOP_PLAN_ID_PRO|WHOP_PRO_MONTHLY_PRICE_USD|WHOP_PRODUCT_ID_PRO|WHOP_WEBHOOK_SECRET|RESEND_API_KEY|RESEND_FROM_EMAIL|SCANNER_ENABLED|X_DRY_RUN|X_BEARER_TOKEN|PYTHON_SKILL_DIR|PYTHON_EXECUTABLE|SENTINEL_DESK_INQUIRY_EMAIL|SENTINEL_DESK_PRICE_USD)='
...
echo ""
echo "[2/2] pushing hardcoded Week 8 DRY-RUN flags ..."
HARDCODED=(
